    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <input
          ...
          :class="{ invalid: errors.has('confirmedPassword') }"
        />
        <span class="error-msg">{{ errors.first("confirmedPassword") }}</span>
      </div>
      <div class="controls">
        <input
          type="checkbox"
          v-model="agreement"
          name="agreement"
          v-validate="{ required: true, ag: true }"
...
export default {
  ...
  methods: {
    ...
    async register() {
      ...
      if (validateSuccess) {
        try {
          const { phone, code, password, confirmedPassword } = this;
